...
class sports extends StatefulWidget {
  ...
  @override
  State<sports> createState() => _apiState();
}
class _apiState extends State<sports> {
  var listed =[];
  var url = 'https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=091bc366596e48a19451af917ed6d3a1';
  getData() async {
