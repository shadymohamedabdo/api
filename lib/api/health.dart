...
class health extends StatefulWidget {
  ...
  @override
  State<health> createState() => _apiState();
}
class _apiState extends State<health> {
  var listed =[];
  var url = 'https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=091bc366596e48a19451af917ed6d3a1';
  getData() async {
